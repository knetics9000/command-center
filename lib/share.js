  ...
  try {
    out = await askJSON({
      ...
      prompt:
        ...
        `,"credibility":<integer 0-100 estimating source trustworthiness from domain reputation, creator authority, and content quality>,"credReason":"<one short sentence>"}\nReturn ONLY the JSON.`,
      max_tokens: 1600,
    });
  } catch {}
  return {
