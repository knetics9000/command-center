...
export async function debugHealth() {
  ...
  const calls = { steps: () => rollupReq("steps"), "active-zone-minutes": () => rollupReq("active-zone-minutes"), "daily-resting-heart-rate": () => listReq("daily-resting-heart-rate"), sleep: () => listReq("sleep") };
